...
<div class="container">
 <div class="site-title pt-2 pb-2" style="margin-top:30px">
        <h2 class="text-center">Meet the Man Behind TravelJobs</h2>
    </div>
...
@endforeach
    ...
    {{-- Testimonial Section  --}}
    <section class="testimonial pt-5 pb-4" style="margin-bottom:30px;">
        <div class="custom-container">
            <div class="site-title pb-3">
                <h2 class="text-center">Commendations</h2>
                <p class="text-center text-white">Include quotes or stories from Jobseekers who have benefited from <b>TravelJobs FPO's</b> services.</p>
            </div>
