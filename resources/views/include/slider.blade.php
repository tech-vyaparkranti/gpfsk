      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            ...
            {{-- <div class="video-content">
              <span class="cursor typewriter-animation bottomclass" style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.9);">{!! $sliderData->slider_title; !!}</span>
              <p class="cursor typewriter-animation bottomclass" style="font-size:40px;font-weight:bold;text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.9);"><?php echo $sliderData->sort_about;?></p>
