...
<footer class="custom-footer">
    <div class="footer-top">
        <div class="footer-col">
            <img src="{{ isset($WebSetting[0]->logo) ? url($WebSetting[0]->logo) : './assets/img/logo4.png' }}"
        ...
        <div class="footer-col">
            ...
            <ul class="footer-contact">
                <li><i class="fa-regular fa-envelope"></i> <a
                        href="mailto:{{ $WebSetting[0]->email ?? '' }}">{{ $WebSetting[0]->email ?? '' }}</a></li>
                <li><i class="fa-regular fa-phone"></i> <a
                        href="tel:{{ $WebSetting[0]->mobile ?? '' }}">{{ $WebSetting[0]->mobile ?? '' }}</a></li>
