...
<a class="footer-whatsapp" aria-label="Whatsapp Button"
  href="https://wa.me/{{ isset($WebSetting['0']->whatsapp_no) ? $WebSetting['0']->whatsapp_no : '+919648660699' }}"><img
...
<a class="footer-whatsapp footer-call" aria-label="Phone Call Button"
  href="tel:{{ isset($WebSetting['0']->call_no) ? $WebSetting['0']->call_no : '+919648660699' }}"><img
